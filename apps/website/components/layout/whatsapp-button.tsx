...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap bg-[#0a0a0a] px-3 py-2 text-[10px] font-sans font-bold uppercase tracking-[0.3em] text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100 hidden sm:inline-block">
        Napisz do specjalisty
      </span>

      <style jsx>{`
        @keyframes wc-wa-ring {
